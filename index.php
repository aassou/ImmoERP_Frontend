...
<body class="menu-always-on-top">
            ...
            <div class="row">
                ...
                <div class="col-md-10 pull-right">
                    <ul class="header-navigation">
                        <li class="current"><a href="#promo-block">Accueil</a></li>
                                ...
                                <div class="animated flipInX">
                                    <div class="hidden-xs">
                                        ...
                                        <div class="promo-like-text">
                                            <h2>ImooERP</h2>
                                            <p>logiciel de gestion des societes de construction<br> et de promotion immobiliere <a href="javascript:void(0);"> Demo </a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="services-block content content-center" id="services">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <h3>Services Apres Vente gratuit</h3>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12 item">
                    <i class="fa fa-mobile"></i>
                    <h3>Multiplatform</h3>
    ...
    <div class="portfolio-block content content-center" id="portfolio">
        <div class="container">
            <h2 class="margin-bottom-50">Capture <strong>d'ecrane</strong></h2>
        </div>
        <div class="row">
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img1.jpg" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/img1.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img2.jpg" alt="NAME" class="img-responsive">
                    <a href="assets/onepage/img/portfolio/img2.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img3.jpg" alt="NAME" class="img-responsive">
                    <a href="assets/onepage/img/portfolio/img3.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img4.jpg" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/img4.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img5.jpg" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/img5.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img6.jpg" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/img6.jpg" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/img7.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/img7.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/8.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/8.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/9.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/9.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/10.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/10.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/11.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/11.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
            ...
            <div class="item col-md-2 col-sm-6 col-xs-12">
                <img src="assets/onepage/img/portfolio/12.png" alt="NAME" class="img-responsive">
                <a href="assets/onepage/img/portfolio/12.png" class="zoom valign-center">
                    <div class="valign-center-elem">
                        <strong>London City Project</strong>
                        <em>Property</em>
                        <b>Details</b>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          <h2>Tester le Demo <em>Most Full Featured &amp; Powerfull Admin Theme</em></h2>
        </div>
        <div class="col-md-2 text-right">
          <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes&amp;utm_source=download&amp;utm_medium=banner&amp;utm_campaign=metronic_frontend_freebie" target="_blank" class="btn btn-primary">Demo</a>
        </div>
      </div>
    </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="item">
                        <strong>6</strong>
                        ans d'experiences sur<br/> le marche
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="testimonials-block content content-center margin-bottom-65">
        <div class="container">
            <h2>Temoignages <strong>Clients</strong></h2>
            <h4>Lorem ipsum dolor sit amet, consectetuer adipiscing elit</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 text-right">
                    <p class="powered">Visiter notre Site: <a href="http://www.keenthemes.com/">notreSite.com</a></p>
                </div>
                <!-- END COPYRIGHT -->
            </div>
        </div>
